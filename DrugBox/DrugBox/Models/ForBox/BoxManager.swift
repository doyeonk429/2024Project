...
//    func sendNewBoxModel(_ userId: Int, _ boxName: String, _ boxImage: UIImage) {
//        let resizedImage = UIImage.resizeImage(boxImage)
//        let parameters = [
//          [
//            "key": "userId",
//            "value": "\(userId)",
...
//         서버 url
        let rootUrl: String = "http://104.196.48.122:8080/drugbox/add"
        ...
        }, to: rootUrl, method: .post, headers: header)
        .validate()
...
//        }
    ...
    func postInvitationCode(by userid: Int, with inviteCode: String) {
        ...
        let postURL = self.url + "/add/invite-code?inviteCode=\(inviteCode)&userId=\(userid)"
